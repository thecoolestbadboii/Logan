...
def send_start(bot, update):
    ...
    text = "Hey there! My name is Nebula - I'm here to help you manage your groups!\n\
Click Help button to find out more about how to use me to my full potential.\n\n"

    text += "Follow ( @neon_hub ) if you want to keep up with the news, updates and bot downtime!\n\n\
Mainatined by @The_CoolestBadBoii\n\nWant to add me to your group? [Click here!](t.me/Nebula_Robot?startgroup=true)"

    keyboard = [[InlineKeyboardButton(text="Updates", url="https://t.me/neon_hub")]]
